...
from src.utils.consts import URL_SIGN_IN, URL_AUTH, URL_BACKUP_AUTH, URL_SERVER_INTERNAL_BACKUP, URL_SERVER_INTERNAL_RESTORE, URL_SERVER_INTERNAL_STATE, URL_V2
...
def init_app(app: Flask, api: Api):
    ...
    global _init_url_mapping
    if not _init_url_mapping:
        _init_url_mapping = True
        # auth service
