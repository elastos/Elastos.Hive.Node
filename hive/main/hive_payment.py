...
class HivePayment:
    ...
    def get_vault_service_info(self):
        ...
        if not info:
            ...
            del info["_id"]
            data = dict()
            info[VAULT_SERVICE_MAX_STORAGE] = info[VAULT_SERVICE_MAX_STORAGE] \
                if info[VAULT_SERVICE_MAX_STORAGE] < 1024*1024 else info[VAULT_SERVICE_MAX_STORAGE] / (1024 * 1024)
