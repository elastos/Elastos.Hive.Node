...
class HivePaymentTestCase(unittest.TestCase):
    ...
    def test_5_service_storage(self):
        ...
        self.assertTrue(can_access_vault(self.did, VAULT_ACCESS_WR))
        inc_file_use_storage_byte(self.did, 55000000)
        update_db_use_storage_byte(self.did, 55000000)
        self.assertFalse(can_access_vault(self.did, VAULT_ACCESS_WR))
        inc_file_use_storage_byte(self.did, -20000000)
        update_db_use_storage_byte(self.did, 30000000)
        self.assertTrue(can_access_vault(self.did, VAULT_ACCESS_WR))
    ...
    def test_6_service_management_timeout_ONLY_READ(self):
        ...
        inc_file_use_storage_byte(self.did, 910000000)
        update_db_use_storage_byte(self.did, 910000000)
        self.assertTrue(can_access_vault(self.did, VAULT_ACCESS_WR))
